...
select * from stock;
select juice_name,id from stock where juice_name like 'f%';
...
create table tempbill(salseman_name varchar(50),juice_name varchar(50),qty int,price double precision,netvalue double precision,date date,id int,billno int,customer_name varchar(255),mobileno bigint);
...
select * from bill_orginal;
alter table bill_orginal drop column date;
truncate bill_orginal;
...
select juice_name,price,id from stock;
select juice_name from stock where id=1;

truncate tempbill;
select * from orginal_datas;	
select * from orginal_datas where date = '2025-03-02';
truncate orginal_datas;
SELECT * FROM orginal_datas WHERE date BETWEEN '2025-03-02' AND '2025-03-05' order by date;

select sum(netvalue) from orginal_datas;
describe orginal_datas;
select billno from bill_orginal;
SELECT SUM(netvalue) FROM bill_orginal WHERE DATE(date) = '2025-03-02';
SELECT * FROM bill_orginal WHERE DATE(date) = '2025-03-02';
SELECT SUM(netvalue) FROM bill_orginal WHERE DATE(date) = '2025-03-02';
SELECT SUM(netvalue) FROM orginal_datas WHERE STR_TO_DATE(date, '%Y-%m-%d') = '2025-03-02';

select * from orginal_datas where billno = 2;
select sum(netvalue) as total from orginal_datas where billno = 2;